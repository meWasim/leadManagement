...
<head>
  ...
  <meta name="csrf-token" content="gXbqz1eAwwvjE9rQ2cWd0MI9ZCXfzyb30mq20N3a">
...
<body>
  ...
  <section class="wrapper">
    ...
    <div class="container">
      ...
      <div class="text">
        <article>
            <p>Dont need Add operator . For This User Allow All Operator and Service</p>
          <p><b style="font-size: 22px; font-weight: 600;">Uh oh! Looks like you got lost.</b><br>Click back button to go the previous page</p>

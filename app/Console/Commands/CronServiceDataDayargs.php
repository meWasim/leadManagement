...
class CronServiceDataDayargs extends Command
{
  /**
   ...
   * @var string
   */
  protected $signature = 'CronServiceDataDayargs';
   ...
   * @var string
   */
  protected $description = ' The Param  is  date "Y-m-d" format . The comman will be insertorUpdate Daily Service data';
  ...
  public function handle()
  {
    ...
    $description = ' The Param  is  date '.$date_input.'  . The comman will be insertorUpdate Daily Service data';
    $data = ['description' => $description,'signature' => $this->signature,'command' => 'php artisan '.$this->signature,'date' => $date_input,'cron_start_date' => $cron_start_date->format('Y-m-d H:i:s'),'cron_end_date' => $cron_end_date->format('Y-m-d H:i:s'),'total_in_up' => 0,'table_name' => 'service_histories','status' => 'Failure'];

    CronLog::upsert($data,['signature','date'],['description','command','total_in_up','cron_start_date','cron_end_date','table_name','status']);
    ...
    $cron_end_date = new DateTime('now');
    $data = ['description' => $description,'signature' => $this->signature,'command' => 'php artisan '.$this->signature,'date' => $date_input,'cron_start_date' => $cron_start_date->format('Y-m-d H:i:s'),'cron_end_date' => $cron_end_date->format('Y-m-d H:i:s'),'total_in_up' => $no_of_service,'table_name' => 'service_histories','status' => $status];

    ...
    <div class="dashboard-data">
      <div id="dashboardCountrydata" class="dash">
        ...
        <div class="card shadow-sm ">
          ...
          <div class="d-flex align-items-center my-2">
            <span class="badge badge-secondary px-2 bg-primary">
              All Companies({{ count($sumemry) }}) | Operators({{isset($allDataSum)?$allDataSum['operator_count']:''}}) </span>
            ...
            <div class="card-text">
              <table width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    <th>G.Rev/AVG G.Rev<sup><i class="ml-2 mr-2 mt-1 text-dark fa fa-info-circle" title="End User Revenue Before Share / Average End User Revenue Before Share"></i></sup></th>
        ...
        <div class="card shadow-sm revfilter">
          ...
          <div class="d-flex align-items-center my-2">
            <span class="badge badge-secondary px-2 bg-primary">
              &nbsp;<a href="{{ route('report.daily.company.pnldetails','company='.$report['company']->id) }}" class="text-white">
              {{$report['company']['name']}} | Operators({{$report['operator_count']}}) | Last Update: {{$report['updated_at']}} </a></span>
            <span class="flex-fill ml-2 bg-primary w-100 font-weight-bold" style="height: 1px;"></span>
          </div>
          <div class="card-body" style="overflow: scroll;">
            <div class="card-text">
